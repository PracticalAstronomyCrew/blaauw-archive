...
<resource schema="blaauw">
  ...
  It is recommended to query the archive using another program via TAP, like TOPCAT or Python. Some examples on how to work with the database from Python is given in the example `Queries Notebook <https://github.com/PracticalAstronomyCrew/blaauw-archive/blob/master/example/TAPQueries.ipynb>`_.

  For some comprehensive guides on how to use ADQL look at `this tutorial <http://vo.astro.rug.nl/__system__/adql/query/info>`_.
